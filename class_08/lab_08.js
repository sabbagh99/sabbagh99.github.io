...
(function createGreeting(){
    ...
    let getItem = function() {
        ...
        if(userInput === 'hard copy ') {
          item = '<img src="https://media.wired.com/photos/5be4cd03db23f3775e466767/125:94/w_2375,h_1786,c_limit/books-521812297.jpg"/>';
      ...
      const getTotal = ()=>{
        return prompt('how many copy d u want');
      }
